                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center">
                            <h1 className="text-2xl font-bold text-gray-900 font-montserrat-bold">Proloans</h1>
                            <span className="ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 font-montserrat-medium">
                            ...
                            <div className="relative">
                                ...
                                {showUserMenu && (
                                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
                                        ...
                                        <a
                                            href="#"
                                            className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-montserrat-medium"
                                        >
                                            Your Profile
                                        </a>
                                        <a
                                        ...
                                        <div className="border-t border-gray-100">
                                            <button
                                                ...
                                                className="block w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-gray-100 font-montserrat-medium"
                                            >
                                                Sign out
                                            </button>
                                        </div>
                        ...
                        <nav className="flex-1 px-4 py-6 space-y-2">
                            {navigation.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
                                    className={`group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 font-montserrat-medium ${item.current
